...
namespace PensionGame.Web.Pages
{
    public partial class NewSession
    {
        ...
        {
            string[] names_1 = new string[] { "Shymo", "Anička", "Adam", "Bači", "Miki", "Maja", "Matovič", "Zeman", "Sulík", "Ciťo", "Peťo 2D", "Peťo 3D", "Jesus", "Donald Trump", "Joe Biden", "Babiš", "Your mom", "A scientist", "An epidemologist", "My boss" };
