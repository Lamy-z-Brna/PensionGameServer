    ...
    public sealed class EventMapper : IEventMapper
    {
        public Event Map(IEvent source)
        {
            return source switch
            {
                ...
                BondDefaultEvent bde => new Event($"Bond that paid out {bde.BondHolding.YearlyPayment} and expired in {bde.BondHolding.YearsToExpiration} years has defaulted on payments and won't no longer pay out"),
